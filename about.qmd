...
Fondata is a distributor for [Bayes Fusion](https://bayesfusion.com/) artificial intelligence modeling and machine learning software based on Bayes networks. As a reseller of _Genie_, and _Smile_ software we provide training and consulting for model creation and software integration. We offer a day's consulting service with purchase of any of the products. See [Bayes Fusion](https://bayesfusion.com/) for pricing.  
